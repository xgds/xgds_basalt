...
function getAdvancedSearch(formset) {
	var rawTemplate = $('#template-advanced-sample-search').html();
	var compiledTemplate = Handlebars.compile(rawTemplate);
	var newDiv = compiledTemplate({'formset': formset});
	var advancedSearchTemplate = $(newDiv);
	$container.append(advancedSearchTemplate);
	
	//onclick handler
	advancedSearchTemplate.find("#samples_search_btn").click(function(event) {
