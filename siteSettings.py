...
try:
    ...
    pass
XGDS_MAP_SERVER_JS_MAP[GEOCAM_TRACK_TRACK_MONIKIER] = {'ol': 'geocamTrack/js/olActual_TraverseMap.js',
...
XGDS_MAP_SERVER_JS_MAP['Note'] = {'ol': 'xgds_notes2/js/olNoteMap.js',
                                  ...
                                  'columns': ['event_time', 'event_timezone', 'author_name', 'role_name', 'location_name', 'content', 'tag_names','content_url', 'content_thumbnail_url', 'content_name', 'app_label', 'model_type', 'type', 'lat', 'lon', 'alt', 'flight_name','object_type', 'object_id', 'creation_time','pk'],
                                  'hiddenColumns': ['app_label', 'model_type', 'type', 'lat', 'lon', 'alt', 'flight_name', 'content_thumbnail_url', 'content_name', 'object_type', 'object_id', 'creation_time','pk', ],
                                  'searchableColumns': ['name','description','flight_name', 'author_name'],
...
XGDS_MAP_SERVER_JS_MAP[XGDS_SAMPLE_SAMPLE_KEY] = {'ol': 'xgds_sample/js/olSampleMap.js',
                                                  ...
                                                  'columns': ['collection_time', 'collection_timezone', 'name', 'sample_type_name', 'label_number', 'collector_name', 'resource_name', 'thumbnail_image_url', 'region_name', 'pk', 'lat', 'lon', 'alt', 'flight_name', 'app_label', 'model_type', 'type', 'year','number', 'description', 'replicate_name', 'marker_id', 'station_number', 'flir_temperature', 'DT_RowId'],
                                                  'hiddenColumns': ['region_name', 'pk','lat', 'lon', 'alt', 'flight_name', 'app_label', 'model_type', 'type', 'year','number', 'description', 'replicate_name', 'marker_id', 'station_number', 'flir_temperature', 'DT_RowId'],
...
XGDS_MAP_SERVER_JS_MAP['FTIR'] = {'ol': 'xgds_instrument/js/olFtirDataProduct.js',
                                  ...
                                  'columns': ['acquisition_time', 'acquisition_timezone', 'collector_name', 'name', 'description', 'minerals', 'pk', 'view_url', 'app_label', 'model_type', 'type', 'lat', 'lon', 'alt', 'flight_name', 'instrument_name','manufacturer_data_file_url','portable_data_file_url','jsonDataUrl','csvDataUrl', 'ev_name', 'DT_RowId'],
...
XGDS_MAP_SERVER_JS_MAP['pXRF'] = {'ol': 'xgds_instrument/js/olPxrfDataProduct.js',
                                  ...
                                  'columns': ['acquisition_time', 'acquisition_timezone', 'collector_name', 'pretty_fileNumber', 'fillin_total_percent', 'name',  'description', 'label', 'elements', 'pk', 'view_url', 'app_label', 'model_type', 'type', 'lat', 'lon', 'alt', 'flight_name', 'instrument_name','manufacturer_data_file_url','portable_data_file_url','element_results_csv_file_url','jsonDataUrl','csvDataUrl', 'ev_name',
                                              ...
                                              'DT_RowId'],
                                  'hiddenColumns': ['pk', 'view_url', 'app_label', 'model_type','type', 'lat','lon','alt','flight_name','elements','instrument_name','manufacturer_data_file_url','portable_data_file_url', 'element_results_csv_file_url', 'jsonDataUrl','csvDataUrl', 'ev_name', 
                                                    'durationTime', 'ambientTemperature', 'detectorTemperature', 'temperatureUnits', 'validAccumulatedCounts', 'rawAccumulatedCounts',
                                                    'validCountLastPacket', 'rawCountLastPacket', 'liveTime', 'hVDAC', 'hVADC', 'filamentDAC', 'filamentADC', 'pulseLength', 'pulsePeriod', 'filter', 
                                                    'eVperchannel', 'numberofChannels', 'vacuum', 'has_element_percents',
                                                    'DT_RowId'],
