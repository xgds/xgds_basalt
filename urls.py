...
urlpatterns = patterns('',
                       ...
                       (r'^accounts/register/$', 'basaltApp.register.registerUser', {'loginRequired': False}, 'user-registration'),
                       (r'^accounts/activate/(.*)$', 'basaltApp.register.activateUser', {}, 'user-activate'),
                       ...
                       (r'^basaltApp/', include('basaltApp.registerUrls')),
